namespace HuaweiARUnitySDK
{
    ...
    public class ARAnchor
    {
         ...
         * 
         * 该\c Pose在\link ARSession.Update() \endlink 时可能会被更新。
         * @return 当前Anchor的位姿。当且仅当\link GetTrackingState() \endlink返回值为
         * \link ARTrackable.TrackingState.TRACKING\endlink 时，应用才应该使用该位姿。
         * \endif
         */
        public Pose GetPose()
        {
