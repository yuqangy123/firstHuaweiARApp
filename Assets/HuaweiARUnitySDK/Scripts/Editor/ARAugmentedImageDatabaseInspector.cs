...
namespace HuaweiARInternal
{
    ...
    [CustomEditor(typeof(ARAugmentedImageDatabase))]
    ...
    public class AugmentedImageDatabaseInspector : Editor
    {
        ...
        private static ARAugmentedImageDatabase s_DatabaseForQualityJobs = null;
        ...
        private static void _RunDirtyQualityJobs(ARAugmentedImageDatabase database)
        {
            ...
            for (int i = 0; i < dirtyEntries.Count; ++i)
            {
                ...
                s_QualityBackgroundExecutor.PushJob(() =>
                {
                    ...
                    if (database.GetARAugImageDatabaseType() == AREnginesType.GOOGLE_AR_CORE)
                    {
